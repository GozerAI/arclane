...
class BusinessConfigCache:
    ...
    configurable window. Writes (working day changes, plan upgrades) invalidate
    ...
    def put(self, business: Any) -> CachedBusinessConfig:
        ...
        config = CachedBusinessConfig(
            ...
            working_days_remaining=business.working_days_remaining,
            working_days_bonus=business.working_days_bonus,
        )
