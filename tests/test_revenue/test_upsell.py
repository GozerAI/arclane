...
def starter_user(engine):
    beh = UserBehavior(
        business_id=1, plan="starter", credits_used=4, credits_total=5,
...
def pro_user(engine):
    beh = UserBehavior(
        business_id=2, plan="pro", credits_used=10, credits_total=20,
...
class TestUpgradePrompts:
    ...
    def test_no_prompt_under_80pct(self, engine):
        beh = UserBehavior(
            business_id=3, plan="pro", credits_used=5, credits_total=20,
    ...
    def test_prompt_at_100pct_high_priority(self, engine):
        beh = UserBehavior(
            business_id=4, plan="starter", credits_used=5, credits_total=5,
    ...
    def test_no_prompt_top_tier(self, engine):
        beh = UserBehavior(
            business_id=5, plan="enterprise", credits_used=900,
            credits_total=999, cycles_run=100,
...
class TestContextualCTAs:
    def test_cta_for_missing_feature(self, engine):
        beh = UserBehavior(
            ...
            credits_used=3, credits_total=5, cycles_run=5,
            last_active_at=datetime.now(timezone.utc))
        engine.track_behavior(beh)
...
class TestMilestones:
    def test_milestone_at_10_cycles(self, engine):
        beh = UserBehavior(
            ...
            credits_used=3, credits_total=5,
            last_active_at=datetime.now(timezone.utc))
        engine.track_behavior(beh)
    ...
    def test_milestone_at_100(self, engine):
        beh = UserBehavior(
            ...
            credits_used=10, credits_total=20,
            last_active_at=datetime.now(timezone.utc))
        engine.track_behavior(beh)
...
class TestWinback:
    def test_winback_recent_churn(self, engine):
        beh = UserBehavior(
            ...
            credits_used=0, credits_total=20, cycles_run=10,
    ...
    def test_winback_old_churn(self, engine):
        beh = UserBehavior(
            ...
            credits_used=0, credits_total=5, cycles_run=2,
...
class TestEngagementScoring:
    ...
    def test_low_engagement(self, engine):
        beh = UserBehavior(
            ...
            credits_used=0, credits_total=5,
            last_active_at=datetime.now(timezone.utc))
        engine.track_behavior(beh)
    ...
    def test_highly_active_triggers(self, engine):
        beh = UserBehavior(
            ...
            credits_used=40, credits_total=60,
            last_active_at=datetime.now(timezone.utc))
        engine.track_behavior(beh)
...
class TestReonboarding:
    def test_reonboarding_for_inactive(self, engine):
        beh = UserBehavior(
            ...
            credits_used=5, credits_total=20, cycles_run=3,
    ...
    def test_reonboarding_lists_unused_features(self, engine):
        beh = UserBehavior(
            ...
            credits_used=0, credits_total=20, cycles_run=0,
...
class TestTrialMilestones:
    def test_first_cycle_milestone(self, engine):
        beh = UserBehavior(
            ...
            credits_used=1, credits_total=20,
            last_active_at=datetime.now(timezone.utc))
        engine.track_behavior(beh)
...
class TestTrialComparison:
    ...
    def test_no_trial_no_comparison(self, engine):
        beh = UserBehavior(
            ...
            credits_used=0, credits_total=5, cycles_run=0,
            last_active_at=datetime.now(timezone.utc))
        engine.track_behavior(beh)
